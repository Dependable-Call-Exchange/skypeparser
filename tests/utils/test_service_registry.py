...
def mock_services(service_provider):
    ...
    with patch('src.utils.service_registry.get_service_provider', return_value=service_provider) as get_provider_mock:
        ...
        patches = [
            patch('src.utils.service_registry.ContentExtractor', content_extractor_mock),
            patch('src.utils.service_registry.SkypeMessageHandlerFactory', message_handler_factory_mock),
            patch('src.utils.service_registry.FileHandler', file_handler_mock),
            patch('src.utils.service_registry.StructuredDataExtractor', structured_data_extractor_mock),
            patch('src.utils.service_registry.DatabaseConnection', database_connection_mock),
