...
class TestMessageTypeEdgeCases(unittest.TestCase):
    ...
    def test_all_message_types(self):
        ...
        result = self.pipeline.run_pipeline(
            file_path=test_file,
            user_display_name="All Message Types Test"
        )
    ...
    def test_empty_and_minimal_content(self):
        ...
        result = self.pipeline.run_pipeline(
            file_path=test_file,
            user_display_name="Empty Content Test"
        )
    ...
    def test_malformed_and_invalid_content(self):
        ...
        result = self.pipeline.run_pipeline(
            file_path=test_file,
            user_display_name="Malformed Content Test"
        )
    ...
    def test_nested_conversations_and_edge_structures(self):
        ...
        data = SkypeDataFactory.build(
            ...
            conversations=[
                ...
                SkypeConversationFactory.build(
                    ...
                    MessageList=[
                        SkypeMessageFactory.build(text=True, id='normal_msg')
                    ]
                ),
        ...
        data['conversations'][0]['MessageList'][0]['extra_msg_field'] = 'Extra message field'
        ...
        result = self.pipeline.run_pipeline(
            file_path=test_file,
            user_display_name="Nested Structure Test"
        )
    ...
    def test_unknown_message_types(self):
        ...
        messages = [
            ...
            SkypeMessageFactory.build(
                id='missing_type',
                content='This has no message type',
                messagetype=None
            ),
            # Empty message type
            SkypeMessageFactory.build(
        ...
        result = self.pipeline.run_pipeline(
            file_path=test_file,
            user_display_name="Unknown Types Test"
        )
    ...
    def test_corrupted_json_file(self):
        ...
        with self.assertRaises(Exception) as context:
            self.pipeline.run_pipeline(
                ...
                user_display_name="Corrupted File Test"
            )
