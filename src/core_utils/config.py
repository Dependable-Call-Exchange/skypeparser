...
def get_db_config(config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    Extract database configuration from the main configuration.

    Args:
        config (Optional[Dict[str, Any]]): Main configuration dictionary.
...
def setup_logging(config: Dict[str, Any]) -> None:
    ...
    from src.logging.structured_logging import setup_logging as setup_structured_logging
