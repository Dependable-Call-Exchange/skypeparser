...
from src.logging.error_handling import (
    ErrorContext,
...
from src.core_utils.interfaces import ExtractorProtocol, LoaderProtocol, TransformerProtocol
from src.logging.structured_logging import log_call, log_execution_time
...
class ModularETLPipeline:
    ...
    def from_config(cls, config: Dict[str, Any]):
        ...
        """
from src.db.pipeline_factory import PipelineFactory
